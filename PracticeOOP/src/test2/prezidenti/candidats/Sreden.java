...
public class Sreden extends Glasopodavatel{
    public Sreden(String name, char gender, String city, Candidat candidat, boolean isKupen) {
        super(name, gender, city, candidat, isKupen);
        this.chanceForVote = 70;
        this.chanceToMistake = 10;
    }
